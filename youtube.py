...
def Api_Key_Connection():
    Api_Id ="AIzaSyCNj-ZaAz5R63jPbwRj1jN067RAVZ_EVYY"  #enter your api key here
...
#we can use any channel info by having thier channel id.
...
def playlists_table():
    ...
    cursor = mydb.cursor()
    #use your local connection above
